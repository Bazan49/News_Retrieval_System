...
from src.RAGModule.Infrastructure.mistral_generator import MistralGenerator
...
class RAGContainer(containers.DeclarativeContainer):
    ...
    mistral_generator = providers.Singleton(
        MistralGenerator,
        api_key=settings.provided.mistral_api_key, 
        model_id=settings.provided.model_id,
        temperature=settings.provided.temperature,
        max_tokens=settings.provided.max_tokens,
        frequency_penalty=settings.provided.frequency_penalty,
        presence_penalty=settings.provided.presence_penalty,
